...
![widget简介](https://github.com/longtaozz/my_img/blob/master/hub_materials/%E5%9B%BE%E7%89%871.png?raw=true)
#### Container（容器）
...
如：无限大  
![container容器](https://github.com/longtaozz/my_img/blob/master/hub_materials/%E5%9B%BE%E7%89%872.png?raw=true)  
看构造  
![container容器](https://github.com/longtaozz/my_img/blob/master/hub_materials/%E5%9B%BE%E7%89%873.png?raw=true)  
只要一一了解容器构造参数就差不多了

**Alignment（定位）**
用于控件绘制定位，通过相对横纵坐标将控件放置在盒子里  
![container容器](https://github.com/longtaozz/my_img/blob/master/hub_materials/%E5%9B%BE%E7%89%874.png?raw=true)  
Alignment继承自AlignmentGeometry  
![container容器](https://github.com/longtaozz/my_img/blob/master/hub_materials/%E5%9B%BE%E7%89%875.png?raw=true)  
**Child（小部件）**
&nbsp;&nbsp;&nbsp;&nbsp;控件容器，如果不设置子属性（row,column,stack），这个小容器只能容纳一个控件  

**Constraints（约束）**
&nbsp;&nbsp;&nbsp;&nbsp;通过BoxConstraints约束容器大小，优先级大于直接设置大小（height，width）  
![container容器](https://github.com/longtaozz/my_img/blob/master/hub_materials/%E5%9B%BE%E7%89%876.png?raw=true)  

**Decoration（背景装饰）**
&nbsp;&nbsp;&nbsp;&nbsp;设置边框、背景色、背景图片、圆角等属性，图片变换。这种图片变换和位置无关，只是绘制改变，还是在原来的位置   
&nbsp;&nbsp;&nbsp;&nbsp;Decoration和color不能同时设置，背景色需要在decoration中设置  
![container容器](https://github.com/longtaozz/my_img/blob/master/hub_materials/%E5%9B%BE%E7%89%877.png?raw=true)  
BoxDecoration继承自Decoration  
![container容器](https://github.com/longtaozz/my_img/blob/master/hub_materials/%E5%9B%BE%E7%89%878.png?raw=true)  

**ForegroundDecoration（前景）**
&nbsp;&nbsp;&nbsp;&nbsp;和它兄弟decoration差不多，区别在与它是前景，是会遮盖住容器内容的，所以一般用来写透明层，使用和decoration一样都是用BoxDecoration设置属性  
![图片](https://github.com/longtaozz/my_img/blob/master/hub_materials/%E5%9B%BE%E7%89%879.png?raw=true)  

**Transfrom（变化转换）**
&nbsp;&nbsp;&nbsp;&nbsp;图片变化旋转，比较复杂下面再讲，写个  
![图片](https://github.com/longtaozz/my_img/blob/master/hub_materials/%E5%9B%BE%E7%89%8710.png?raw=true)  
一些Matrix4用法可以看源码  
![图片](https://github.com/longtaozz/my_img/blob/master/hub_materials/%E5%9B%BE%E7%89%8711.png?raw=true)  
...
&nbsp;&nbsp;&nbsp;&nbsp;填充其余控件没用到的部分  
![图片](https://github.com/longtaozz/my_img/blob/master/hub_materials/%E5%9B%BE%E7%89%8712.png?raw=true)  
#### Row（水平）
这个东西和LinearLayout一样的，垂直布局  
构建：  
![图片](https://github.com/longtaozz/my_img/blob/master/hub_materials/%E5%9B%BE%E7%89%8713.png?raw=true)  

**mainAxisSize（主轴大小）**
看构造可以知道，默认为max  
![图片](https://github.com/longtaozz/my_img/blob/master/hub_materials/%E5%9B%BE%E7%89%8715.png?raw=true)  
...
![MainAxisAlignment](https://github.com/longtaozz/my_img/blob/master/hub_materials/%E5%9B%BE%E7%89%8716.png?raw=true)  
...
#### Image（图片部件）
图片展示部件，看构造源码  ＜/br＞
![MainAxisAlignment](https://github.com/longtaozz/my_img/blob/master/hub_materials/%E5%9B%BE%E7%89%8717.png?raw=true)  
多了一个新单词@required，在dart中为必填参数的意思  

**Image（加载图片，必填属性）**
&nbsp;&nbsp;&nbsp;&nbsp;一个有网络图片加载框架的控件，有四种加载方式，先知道他的用法，有时间再查看细细探究  
![MainAxisAlignment](https://github.com/longtaozz/my_img/blob/master/hub_materials/%E5%9B%BE%E7%89%8718.png?raw=true)  
...
```
#### Icon（图标）
构建图标，<label style="color:red">图标不可交互</label>，直接看构造
``` kotlin
...
这类的不会用啊。。  
找他的子类  
![MainAxisAlignment](https://github.com/longtaozz/my_img/blob/master/hub_materials/%E5%9B%BE%E7%89%8719.png?raw=true)  
有那么都，随便找个（我找个圆角的）  
